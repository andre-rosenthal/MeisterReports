...
<body>
    <form id="form1" runat="server">
         <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <br />
            <br />
            Select between the two options<br />
...
&nbsp;&nbsp;&nbsp;
            ...
            <br />
                ...
                <br />
                      ...
                      <asp:Panel ID="DOWs" runat="server">
                          ...
                          <br />
                          Hour Slot:&nbsp;&nbsp;&nbsp;
                          <asp:TextBox ID="TextBox7" runat="server" CausesValidation="True" MaxLength="2" Width="33px" OnTextChanged="TextBox7_TextChanged" ToolTip="00-23 as Hour"></asp:TextBox>
                          <br />
                          <br />
       ...
       <div id="AfterB2" runat="server">
        ...
        <p>
            <asp:Label ID="Label5" runat="server" Text="Return Message"></asp:Label>
        </p>
        <p>
            <asp:TextBox ID="TextBox3" runat="server" Height="45px" Width="749px"></asp:TextBox>
        </p>
          </div>
                 </ContentTemplate>
               <Triggers>
